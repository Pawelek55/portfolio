...
$(document).scroll(function () {
    if (window.outerWidth > 920) {
        ...
        if (($(this).scrollTop() > $('.html').position().top - 850)) {
            $('.html').addClass('bounceInLeft');
...
$(document).scroll(function () {
    if (window.outerWidth > 920) {
        if ($(this).scrollTop() > $('.js').position().top - 550) {
        ...
        if ($(this).scrollTop() > $('.js').position().top - 850) {
            $('.js').addClass('bounceInLeft');
        } else {
            $('.js').removeClass('bounceInLeft');
        }
...
$(document).scroll(function () {
    if (window.outerWidth > 920) {
        if ($(this).scrollTop() > $('.bootstrap').position().top - 550) {
        ...
        if ($(this).scrollTop() > $('.bootstrap').position().top - 850) {
            $('.bootstrap').addClass('bounceInLeft');
        } else {
            $('.bootstrap').removeClass('bounceInLeft');
        }
...
$(document).scroll(function () {
    if (window.outerWidth > 920) {
        if ($(this).scrollTop() > $('.gulp').position().top - 550) {
        ...
        if ($(this).scrollTop() > $('.gulp').position().top - 850) {
            $('.gulp').addClass('bounceInLeft');
        } else {
            $('.gulp').removeClass('bounceInLeft');
        }
...
$(document).scroll(function () {
    if (window.outerWidth > 920) {
        if ($(this).scrollTop() > $('.rwd').position().top - 550) {
        ...
        if ($(this).scrollTop() > $('.rwd').position().top - 850) {
            $('.rwd').addClass('bounceInLeft');
        } else {
            $('.rwd').removeClass('bounceInLeft');
        }
...
$(document).scroll(function () {
    if (window.outerWidth > 920) {
        if ($(this).scrollTop() > $('.css').position().top - 550) {
        ...
        if ($(this).scrollTop() > $('.css').position().top -850) {
            $('.css').addClass('bounceInRight');
        } else {
            $('.css').removeClass('bounceInRight');
        }
...
$(document).scroll(function () {
    if (window.outerWidth > 920) {
        if ($(this).scrollTop() > $('.jquery').position().top - 550) {
        ...
        if ($(this).scrollTop() > $('.jquery').position().top - 850) {
            $('.jquery').addClass('bounceInRight');
        } else {
            $('.jquery').removeClass('bounceInRight');
        }
...
$(document).scroll(function () {
    if (window.outerWidth > 920) {
        if ($(this).scrollTop() > $('.ajax').position().top - 550) {
        ...
        if ($(this).scrollTop() > $('.ajax').position().top - 850) {
            $('.ajax').addClass('bounceInRight');
        } else {
            $('.ajax').removeClass('bounceInRight');
        }
...
$(document).scroll(function () {
    if (window.outerWidth > 920) {
        if ($(this).scrollTop() > $('.sass').position().top - 550) {
        ...
        if ($(this).scrollTop() > $('.sass').position().top - 850) {
            $('.sass').addClass('bounceInRight');
        } else {
            $('.sass').removeClass('bounceInRight');
        }
...
$(document).scroll(function () {
    if (window.outerWidth > 920) {
        if ($(this).scrollTop() > $('.git').position().top - 550) {
        ...
        if ($(this).scrollTop() > $('.git').position().top - 850) {
            $('.git').addClass('bounceInRight');
        } else {
            $('.git').removeClass('bounceInRight');
        }
